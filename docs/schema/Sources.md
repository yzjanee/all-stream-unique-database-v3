# Sources
The Sources table contains all objects in the database alongside their coordinates. Each source is expected to be unique and is referred to by all other object tables.


Columns marked with an exclamation mark (❗️) may not be empty.
| Column Name | Description | Datatype | Length | Units  | UCD |
| --- | --- | --- | --- | --- | --- |
| ❗️ <ins>source</ins> | Unique identifier for the source (e.g. Gaia DR3 <source_id>) | string | 100 |  | meta.id;src;meta.main  |
| ra_deg | Right Ascension of the source, ICRS | double |  | deg | pos.eq.ra;meta.main  |
| dec_deg | Declination of the source, ICRS | double |  | deg | pos.eq.dec;meta.main  |
| epoch_year | Decimal year for coordinates (e.g. 2016.0 for Gaia DR3) | double |  | yr |   |
