# ModeledParameters
The ModeledParameters table contains derived/inferred parameters for sources listed in the Sources table. The combination of *source*, *parameter*, and *reference* is expected to be unique. The *parameter* name links to the ParameterList lookup table.
...
| ❗️ unit | Unit of the parameter value; should be astropy-units compatible | string | 30 |  | meta.unit  |
